...
// (Phase 4, god-file split) into packages/business/src/mail/ as five
...
//   policy-decision-log.ts  — shared legacy audit-log writer
//
...
export * from "./mail/policy-decision-log";
