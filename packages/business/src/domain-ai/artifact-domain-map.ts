...
export interface DomainLane { domain: DomainKey; status: 'done' | 'active' | 'pending'; artifacts: LaneArtifact[]; autonomy?: import('./project-decision').Autonomy; proposals?: Array<{ id: string; domain: string; title: string; bodyMarkdown: string; createdAt: Date; colorGate?: import('./color-gate-llm').ColorGateVerdict }>; }
