...
function defaultPolicyMemories(): SeedPolicyMemory[] {
  const seeds: SeedPolicyMemory[] = [
    ...
    },
    {
      memoryType: "system_sender_domain",
      key: "microsoft.com",
      label: "Microsoft platform mail",
      valueJson: { domain: "microsoft.com", reason: "vendor subscription/marketing/system mail" },
      source: "seed",
      confidence: 100,
      status: "active",
    },
    {
      memoryType: "system_sender_domain",
      key: "mails.microsoft.com",
      label: "Microsoft mails host",
      valueJson: { domain: "mails.microsoft.com", reason: "vendor marketing host" },
      source: "seed",
      confidence: 100,
      status: "active",
    },
