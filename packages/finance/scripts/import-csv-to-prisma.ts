/**
 * Import Notion CSV exports (CFO databases) into the finance Prisma schema,
 * then verify the imported rows match the source CSVs field-by-field.
 *
 * Usage:
 *   NOTION_CSV_DIR="/path/to/개인 페이지 & 공유된 페이지" \
 *     pnpm --filter @sangfor/finance notion:import-csv
 *
