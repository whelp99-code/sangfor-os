...
function env(extra = {}) { const out = {}; for (const key of ['PATH','HOME','LANG','LC_ALL','TERM','NVM_DIR','COREPACK_HOME','PNPM_HOME','RUNNER_TOOL_CACHE','TMPDIR']) if (process.env[key]) out[key] = process.env[key]; return { ...out, ...extra }; }
