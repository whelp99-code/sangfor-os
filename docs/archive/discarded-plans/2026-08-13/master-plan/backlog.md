...
- **F-트랙(기능 확장 10선)**: 정본은 `08-six-month-roadmap.md` §8.5 — F1 리뉴얼 레이더(M2) 외 9건, 실측 전제·생존 서열 포함. 개별 항목을 이 backlog에 중복 기재하지 않는다.
