export type Deal = {
  ...
  title: string;
  stage: string;
  dealStatus: string | null;        // OPEN/WON/LOST/... (sourced from opportunity.dealStatus)
  probability: number;
  ...
  protectionExpiresAt: string | null; // ISO date string for APPROVED protection expiry (D-day)
