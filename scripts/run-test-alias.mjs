...
const RUNTIME_BASE_KEYS = ["API_KEY", "AUTH_DEMO_PASSWORD", "CI_INTEGRATION", "COREPACK_HOME", "DEFAULT_PROJECT_ID", "DEFAULT_PROJECT_SLUG", "FINANCE_API_KEY", "HOME", "INTERNAL_PRINCIPAL_CLOCK_SKEW_SECONDS", "INTERNAL_PRINCIPAL_ENGINEER_ACTIVE_KID", "INTERNAL_PRINCIPAL_ENGINEER_KEYRING_JSON", "INTERNAL_PRINCIPAL_FINANCE_ACTIVE_KID", "INTERNAL_PRINCIPAL_FINANCE_KEYRING_JSON", "INTERNAL_PRINCIPAL_ROTATION_OWNER", "INTERNAL_PRINCIPAL_SCHEDULER_ACTIVE_KID", "INTERNAL_PRINCIPAL_SCHEDULER_KEYRING_JSON", "INTERNAL_PRINCIPAL_TTL_SECONDS", "INTERNAL_PRINCIPAL_WORKFLOW_ACTIVE_KID", "INTERNAL_PRINCIPAL_WORKFLOW_KEYRING_JSON", "LANG", "LC_ALL", "MCP_API_KEY", "NVM_DIR", "NO_COLOR", "PATH", "PNPM_HOME", "SANGFOR_API_KEY", "SANGFOR_APP_DATABASE_URL", "SANGFOR_OPERATOR_PRINCIPAL_ID", "SHELL", "TERM", "TMPDIR", "USER_JWT_ACTIVE_KID", "USER_JWT_AUDIENCE", "USER_JWT_CLOCK_SKEW_SECONDS", "USER_JWT_ISSUER", "USER_JWT_KEYRING_JSON", "USER_JWT_ROTATION_OWNER", "USER_JWT_TTL_SECONDS", "UX_AUTH_STORAGE_STATE_DIR", "UX_FIXTURE_APPROVAL_ID", "UX_FIXTURE_CORRUPT_APPROVAL_ID", "UX_FIXTURE_CUSTOMER_ID", "UX_FIXTURE_DEAL_ID", "UX_FIXTURE_KNOWLEDGE_ID", "UX_FIXTURE_PARTNER_ID", "UX_FIXTURE_POC_ID", "UX_FIXTURE_PROJECT_ID", "UX_FIXTURE_PROPOSAL_ID", "UX_FIXTURE_STALE_APPROVAL_ID", "UX_FIXTURE_SUPPORT_ID", "UX_FIXTURE_TASK_ID", "WHELP99_ENFORCE_SAFE_TOOLS", "XDG_CACHE_HOME"];
